...
## exer: find min max of one feature
valList = []
featureName = "salary"
for p in data_dict:
    if data_dict[p][featureName] == 'NaN': continue
    valList.append(data_dict[p][featureName])

print "min =", min(valList), ", max =", max(valList)
